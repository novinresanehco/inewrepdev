...
// **تغییر: بررسی $_SESSION['display_mode']**
if ( isset($_SESSION['display_mode']) && $_SESSION['display_mode'] == 'single') {
    $show_posts = false; // اگر صفحه تکی است، لیست پست‌ها را نمایش نده
}
